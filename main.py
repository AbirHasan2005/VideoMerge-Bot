...
async def start_handler(bot: Client, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("Developer - @Krk_kanish", url="https://t.me/Krk_kanish")],
                [InlineKeyboardButton("Support Group", url="https://t.me/Ottblasters"),
                 InlineKeyboardButton("Movies Channel", url="https://t.me/Ottblasters")],
